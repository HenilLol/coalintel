      ...
      <CardHeader className="py-3.5 px-4 bg-[#20313D] border-b border-[#2C3D49]">
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm font-semibold text-[#F1F5F7] flex items-center gap-2">
            <History className="h-4 w-4 text-[#18B6B2]" />
              ...
              {loading ? (
                ...
                reports.map((r) => (
                  <tr
                    ...
                    className="hover:bg-[#20313D]/50 transition-colors cursor-pointer group"
                  >
                    <td className="py-3.5 px-4 font-sans font-semibold text-[#F1F5F7]">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <span className="text-[11px] font-mono text-[#9EADB7] font-normal">
                    ...
                    <td className="py-3.5 px-4 text-[#9EADB7]">
                      <span className="font-semibold block text-[#F1F5F7]">{r.subsidiary || 'ECL'}</span>
                      <span className="text-[11px] text-[#F2A900] font-semibold">{r.fiscal_year || '2023-24'}</span>
                    </td>
