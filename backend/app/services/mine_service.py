    ...
    for m in mines:
        ...
        results.append(
            MineSummaryResponse(
                ...
                financial_year=getattr(m, 'financial_year', None) or "2024-25",
                verification_status=getattr(m, 'verification_status', None) or "verified",
                data_origin=getattr(m, 'data_origin', None) or "OFFICIAL",
...
def get_mine_detail(db: Session, mine_id: str) -> Optional[MineDetailResponse]:
    ...
    return MineDetailResponse(
        ...
        financial_year=getattr(mine, 'financial_year', None) or "2024-25",
        ...
        verification_status=getattr(mine, 'verification_status', None) or "verified",
        data_origin=getattr(mine, 'data_origin', None) or "OFFICIAL",
